...
if ( ! function_exists('leshavin_wa') ) {
  // Digits-only number for wa.me links. Kept separate from
  // leshavin_phone(), which returns the "+254 792 331 941" DISPLAY
  // format - passing that into a wa.me URL (with the "+" and spaces)
  // is what was producing WhatsApp's "page not found" / invalid link
  // error on the topbar and header WhatsApp buttons.
  function leshavin_wa() { return '254792331941'; }
}
...
<nav class="lph-mnav" id="lphMnav" aria-label="Mobile navigation">
  ...
  <a href="<?php echo esc_url( home_url('/submit-prescription') ); ?>" class="lph-mnav-link<?php echo is_page('submit-prescription') ? ' active' : ''; ?>">Submit Prescription</a>
...
<div class="lph-topbar" id="lphTopbar">
  ...
  <div class="lph-topbar-socials">
    ...
    <a href="https://wa.me/<?php echo esc_attr( leshavin_wa() ); ?>" target="_blank" rel="noopener noreferrer" class="lph-tsoc" aria-label="WhatsApp">
...
<div class="lph-sticky-wrap" id="lphStickyWrap">
  ...
  <div class="lph-header">
    ...
    <div class="lph-header-actions">
      <a href="https://wa.me/<?php echo esc_attr( leshavin_wa() ); ?>" target="_blank" rel="noopener noreferrer" class="lph-call">
